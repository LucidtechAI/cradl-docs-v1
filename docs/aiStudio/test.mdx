...
<p>The model:</p>
<ul> 
<li> predicted every 5/6 `fields` correctly except for `currency`. </li>
<li> predicted `total_amount` correctly, but the correct option was third likeliest prediction. </li>
