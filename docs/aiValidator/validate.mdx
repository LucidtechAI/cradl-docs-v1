...
# Validate documents
:::info
This guide assumes that you have created, trained and tested your AI Model.
:::

## 1. Upload documents 
Welcome do the `AI Validator`. Simply upload a document.
...
- Your corrections will be used to improve the model when you retrain it. (Retraining the model will be explained in a later section). 
<div class="image-backdrop utils-mb-10">
